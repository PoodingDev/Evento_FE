    ...
    <div className="flex h-[29rem] w-[43rem] translate-x-[3rem] justify-center rounded-[1.25rem] bg-eventoWhite p-[2.8rem] shadow-xl shadow-lightGray/50">
      ...
      <div className="flex flex-col w-full">
        ...
        >
          ...
          {showCalList && (
            <div className="scrollbar-custom absolute left-[0.5rem] top-[1.9rem] h-[8rem] mt-[0.3rem] w-[8rem] flex-col justify-center space-y-[0.1rem] overflow-auto rounded-lg bg-eventoWhite first-letter:flex">
