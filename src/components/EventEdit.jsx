      ...
      <div className="flex w-full flex-col">
        ...
        <div className="mb-[2rem]">
          ...
          <input
            ...
            className="flex h-[2rem] w-[15rem] items-center rounded-md bg-lightGray/30 pb-[0.5rem] pl-[0.2rem] pt-[0.5rem] text-[1.2rem] text-darkGray placeholder-lightGray focus:outline-none"
          />
        </div>
