...
export default function EventInfo() {
  ...
  return (
    <div className="flex h-[29rem] w-[37rem] w-[43rem] translate-x-[3rem] flex-col justify-center rounded-[1.25rem] bg-eventoWhite p-[2.8rem] shadow-xl shadow-lightGray/50">
      ...
      {isComment ? (
        ...
        <div className="mb-[2.5rem] flex h-[1.5rem] w-[10rem] justify-center rounded-[3rem] bg-eventoYellow text-center text-[1.25rem] font-bold leading-[1.7rem]">
          <FaCaretDown size={25} onClick={showList} />
          <p>Pooding팀</p>
          {showCalList && (
            <div className="absolute left-[4.4rem] top-[9.85rem] flex h-[4rem] flex-col overflow-auto">
              <button className="h-[1.5rem] w-[6.7rem] border-[0.1rem] border-solid border-darkGray bg-lightGray leading-[1.5rem]">
                PoodingDev
              </button>
              <button className="h-[1.5rem] w-[6.7rem] border-[0.1rem] border-solid border-darkGray bg-lightGray leading-[1.5rem]">
                캘린이의 삶
