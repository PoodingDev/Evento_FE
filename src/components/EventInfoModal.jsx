    ...
    <div className="ml-[18rem] flex h-screen items-center justify-center pt-[5rem]">
      <div className="h-[28rem] w-[48rem] rounded-[2.5rem] bg-eventoWhite p-[2.8rem] shadow-[0_0_2.5rem_gray]">
        <div className="flex flex-wrap justify-between">
          ...
          {isEdit ? (
            ...
            <input
              ...
              className="h-[3.8rem] w-[30rem] pb-[1rem] text-[2.8rem] font-bold"
            />
          )}
          <FaXmark size={25} />
        </div>
        ...
        {isEdit ? (
          ...
          <div className="bg-eventoYellow mb-[3.3rem] flex h-[1.5rem] w-[10rem] justify-center rounded-[3rem] text-center text-[1.2rem] font-bold leading-[1.7rem]">
            <FaCaretDown size={25} />
            <p>Pooding팀</p>
          </div>
        )}
